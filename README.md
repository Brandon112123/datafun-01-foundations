...
uv run python src/datafun_01_foundations/app_brandon.py
```
...
1. Rename `app_brandon.py` to reflect your name or alias.
...
2. Edit this README.md file to change the run command to call your file instead.
   Use CTRL+f to search for `app_brandon.py` and replace all occurrences exactly.
